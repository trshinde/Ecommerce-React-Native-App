  ...
  An electronics shopping eCommerce React Native app with display of electronic items and based on whichever item or product selected, shopping cart gets updated     with a particular item.   
